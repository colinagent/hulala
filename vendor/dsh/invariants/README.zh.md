...
import InvariantRegistry from '@loopwithai/dsh-invariants'
import * as SessionInvariant from '@loopwithai/dsh-session/invariant'
...
ctx.plugin(InvariantRegistry, {
  ...
  package_blocklist: ['^@loopwithai/dsh-agent-loop$'],
})
