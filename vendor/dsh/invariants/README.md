...
import InvariantRegistry from '@hulala/dsh-invariants'
import * as SessionInvariant from '@hulala/dsh-session/invariant'
...
ctx.plugin(InvariantRegistry, {
  ...
  package_blocklist: ['^@hulala/dsh-agent-loop$'],
})
