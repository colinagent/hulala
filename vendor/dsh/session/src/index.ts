 ...
 *
 * @module @loopwithai/dsh-session
 */

import { Context, Service } from '@loopwithai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@loopwithai/dsh-llm'
import { scopeOf, scopeTarget } from '@loopwithai/dsh-scope'
import type { Scoped } from '@loopwithai/dsh-scope'
import type { Message } from '@loopwithai/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@loopwithai/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@loopwithai/dsh-llm'
...
declare module '@loopwithai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@loopwithai/dsh-scope`): agent-scoped listeners
     ...
     * Scope-filtered dispatch (`@loopwithai/dsh-scope`) reuses the owner scope.
     ...
     * (`@loopwithai/dsh-scope`) reuses the session's owner scope.
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@loopwithai/dsh-session#Session',
