 ...
 *
 * @module @hulala/dsh-session
 */

import { Context, Service } from '@hulala/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@hulala/dsh-llm'
import { scopeOf, scopeTarget } from '@hulala/dsh-scope'
import type { Scoped } from '@hulala/dsh-scope'
import type { Message } from '@hulala/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@hulala/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@hulala/dsh-llm'
...
declare module '@hulala/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@hulala/dsh-scope`): agent-scoped listeners
     ...
     * Scope-filtered dispatch (`@hulala/dsh-scope`) reuses the owner scope.
     ...
     * (`@hulala/dsh-scope`) reuses the session's owner scope.
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@hulala/dsh-session#Session',
