 ...
 * @module @hulala/dsh-session-persistence
 */

import { Context, Service } from '@hulala/cordis'
import { SessionPreparation } from '@hulala/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@hulala/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@hulala/dsh-session'
