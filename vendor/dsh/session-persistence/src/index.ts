 ...
 * @module @loopwithai/dsh-session-persistence
 */

import { Context, Service } from '@loopwithai/cordis'
import { SessionPreparation } from '@loopwithai/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@loopwithai/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@loopwithai/dsh-session'
